...
export const WORLD_PRICING_TIERS: WorldPricingTier[] = [
  {
    key: "core",
    name: "FOUNDATION",
    tagline: "Lock the baseline",
    price: "₹7K",
    description:
      "Core cadence architecture. Private accountability. A floor that does not bargain with drift.",
    features: [],
  },
  {
    key: "pro",
    name: "ACCELERATION",
    tagline: "Pressure, clarity, proximity to the standard",
    price: "₹15K",
    features: [
      "Weekly synchronous review — no narrative drift",
      "Communication and presence tuned to real stakes",
      "Execution loops with explicit finish lines",
      "Access to the closed operator surface",
    ],
    recommended: true,
  },
  {
    key: "black",
    name: "SOVEREIGN",
    tagline: "Discretion-first trajectory design",
    price: "₹35K",
    priceAlt: "or ₹55K",
    features: [
      "Everything in Acceleration",
      "Discrete layer — signal over audience",
      "Environment and identity calibrated to outcome",
      "Peer alignment on seriousness — never on volume",
    ],
    footnote: "Invitation after review · Acceptance is scarce",
  },
];
