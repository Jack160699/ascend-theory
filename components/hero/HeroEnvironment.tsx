 ...
 */
export function HeroEnvironment({ sectionRef, className }: HeroEnvironmentProps) {
  ...
  return (
    <div
      className={cn("ascend-hero-env-base", className)}
      aria-hidden
    >
      <div className="ascend-hero-architect-field" />
      <div className="ascend-hero-directional-sheen" />

      <motion.div style={{ y: yFar }} className="absolute -left-[12%] top-[18%] sm:-left-[8%] sm:top-[22%]">
        <motion.div
          className={cn(
      ...
      <motion.div style={{ y: yMid }} className="absolute -right-[10%] top-[14%] sm:-right-[6%] sm:top-[18%]">
        <motion.div
          className={cn(
      ...
      <motion.div
        style={{ y: yNear }}
        className="absolute bottom-[18%] left-[12%] hidden sm:block"
      >
        <motion.div
          className={cn(
      ...
      <div className="ascend-hero-floor-read" />
    </div>
  );
}
